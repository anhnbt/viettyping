...
- [x] Tích hợp HTML5 Canvas render các đường viền SVG rỗng của nhân vật hoạt họa quen thuộc.
- [x] Xây dựng công cụ cọ vẽ (brush) và bảng màu rực rỡ, bắt mắt cho trẻ em.
- [x] Triển khai thuật toán kiểm tra pixel thời gian thực:
...
- [x] Phát âm thanh bong bóng vỡ vui nhộn khi di chuyển cọ vẽ và hiển thị các vi hiệu ứng pháo hoa nhỏ khi trẻ tô kín thành công một vùng lớn.
- [x] Trả về các thông số `colorCoveragePercent` và `colorBleedPercent` trong `TelemetryPayload`.
