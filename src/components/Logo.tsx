...
export const Logo: React.FC<LogoProps> = ({ className = 'w-10 h-10' }) => {
  return (
    ...
    >
      ...
      {/* Dino Spikes (Dynamic Secondary Color) */}
      <path d="M 28 32 L 23 20 L 33 27 Z" fill="var(--color-secondary)" stroke="#1E293B" strokeWidth="3.5" />
      <path d="M 40 29 L 36 17 L 46 25 Z" fill="var(--color-secondary)" stroke="#1E293B" strokeWidth="3.5" />
      <path d="M 52 30 L 53 18 L 59 29 Z" fill="var(--color-secondary)" stroke="#1E293B" strokeWidth="3.5" />
      ...
      {/* Checkmark / 'v' inside Keycap (Dynamic Primary Color) */}
      <path d="M 38 56 L 44 62 L 53 50" stroke="var(--color-primary)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      ...
      {/* Dino Rosy Cheek */}
      <circle cx="80" cy="53" r="3" fill="var(--color-secondary)" opacity="0.8" />
