    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-amber-50 border-4 border-slate-800 rounded-[32px] p-6 md:p-8 shadow-[8px_8px_0px_0px_#1e293b] overflow-hidden z-10"
        >
          ...
          {canClose && (
            <button
              ...
              className="absolute top-4 right-4 p-2 bg-white hover:bg-rose-100 text-slate-700 hover:text-rose-650 border-2 border-slate-800 rounded-full shadow-[2px_2px_0px_0px_#1e293b] active:translate-y-[1px] active:shadow-none transition-all cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          )}
          ...
          <div className="absolute top-0 left-0 right-0 h-3 bg-gradient-to-r from-red-400 via-yellow-400 to-indigo-400" />
